...
<section class="main-banner-section">
   <div class="banner-parellax">
   <div class="banner_main">
        <?php if(get_field('video_link')) { ?>
      <div class="video-container">
         <video autoplay="" loop="" muted="">
            <source src="<?php echo get_field('video_link'); ?>" type="video/mp4">
            <source src="https://cdn2.hubspot.net/hubfs/2365968/Website%202018/Home/Video/Website%20Background%20Video.webm" type="video/webm">
        ...
        ?>
            <div id="serviceList" class="carousel slide clearfix" data-ride="carousel">
               ...
               <ol class="carousel-indicators clearfix">
                  <li data-target="#serviceList" data-slide-to="0" class="item0 wow fadeInDown animated" data-wow-offset="200" data-wow-delay="300ms" style="visibility: visible;-webkit-animation-delay: 300ms; -moz-animation-delay: 300ms; animation-delay: 300ms;"><strong><?php echo $select_page[0]->post_title;?></strong><span>0</span></li>
                  <li data-target="#serviceList" data-slide-to="1" class="item1 wow fadeInDown animated" data-wow-offset="200" data-wow-delay="200ms" style="visibility: visible;-webkit-animation-delay: 200ms; -moz-animation-delay: 200ms; animation-delay: 200ms;"><strong><?php echo $select_page[1]->post_title;?></strong><span>1</span></li>
                  <li data-target="#serviceList" data-slide-to="2" class="item2 wow fadeInDown animated" data-wow-offset="200" data-wow-delay="200ms" style="visibility: visible;-webkit-animation-delay: 200ms; -moz-animation-delay: 200ms; animation-delay: 200ms;"><strong><?php echo $select_page[2]->post_title;?></strong><span>2</span></li>
                  <li data-target="#serviceList" data-slide-to="3" class="item3 wow fadeInDown animated active" data-wow-offset="200" data-wow-delay="200ms" style="visibility: visible;-webkit-animation-delay: 200ms; -moz-animation-delay: 200ms; animation-delay: 200ms;"><strong><?php echo $select_page[3]->post_title;?></strong><span>3</span></li>
                  <li data-target="#serviceList" data-slide-to="4" class="item4 wow fadeInDown animated" data-wow-offset="200" data-wow-delay="200ms" style="visibility: visible;-webkit-animation-delay: 200ms; -moz-animation-delay: 200ms; animation-delay: 200ms;"><strong><?php echo $select_page[4]->post_title;?></strong><span>4</span></li>
               </ol>
               <!-- Wrapper for slides -->
